...
if($_POST['action']=='getMinicart') 
{
	...
	{
		echo "<img src='http://www.clker.com/cliparts/A/3/i/C/H/E/koszyk.svg' width='25' height='25' alt='' title='Show Cart' /> <font color='red'> ".$num."</font> Items (0 ".$curr.")";
		exit();
	}
	...
	echo "<img src='http://www.clker.com/cliparts/A/3/i/C/H/E/koszyk.svg' width='45' height='45' alt='' title='Show Cart' /><font color='red'> ".$num."</font> Items (".$totalPrice." ".$curr.")";
}
