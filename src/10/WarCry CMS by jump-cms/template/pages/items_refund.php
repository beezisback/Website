                ...
                <div class="container_3 account-wide" align="center">
					...
					if ($res)
					{
						while ($arr = $res->fetch())
						{
							...
							<ul class="item-row">
								<li class="item-icon">
									<a href="', $config['WoWDB_URL'], '/?item=', $arr['entry'], '" target="_newtab" rel="item=', $arr['entry'], '" id="icon">
										<img style="background-image:url(http://wow.zamimg.com/images/wow/icons/large/inv_misc_questionmark.jpg)"/>
									</a>
								</li>
								<li class="item-info"><h2>Test</h2><h5>', $arr['price'], ' ', ($arr['currency'] == CA_COIN_TYPE_SILVER ? 'Silver' : 'Gold'), ' Coins</h5></li>
