    ...
    <div class="sub-page-title">
  	...
  	<div class="container_2" align="center">
            ...
            <div class="changelogs-cats">
                ...
                <a href="<?php echo $config['BaseURL'];?>/index.php?page=changelogs&changelog=2" <?php echo ($ChangelogID == CHANGELOG_CORE ? 'class="active"' : ''); ?>>Core Changelog<p> MagiCal WoW Core changes and updates</p></a>
                <div class="clear"></div>
            </div>
