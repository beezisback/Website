...
<div class="index_news">
   	...
   	<div class="welcome_to_warcry">
    	<h1>Welcome to MaGiCal-WoW</h1>
        <p>
        MaGiCal is a quality warcraft server utilizing talented developers and resources to ensure the best blizz-like experience around. Our team is a dedicated team that professionally creates and maintain everyday features for the players. Register today!
        </p>
    </div>
	...
	<div class="social-media container">
        <div class="media-buttons-holder"><!-- Media buttons holder -->
				...
				?>
				 ...
				 <?php if ($config['FACEBOOK']['enabled']) { ?>
		         <!-- Facebook -->
		         ...
		         <div class="media-wrapp">
                    <div class="media-button-holder">
	                 	...
	                 	<div class="youtube media-new-design">
	                    	<a href="#" target="_blank"><div class="new-design-left-part"><p class="icon"></p><span>YouTube</span></div></a>
	                    </div>
                        <!-- New Media Button look.End -->
