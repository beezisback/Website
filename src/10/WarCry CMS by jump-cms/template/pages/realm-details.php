  	...
  	<div class="container_2 realm-details" align="center">
    	...
    	<!-- REALM TOP INFO -->
        	<div class="realm_main_info">
                ...
                <img id="expansion" alt="World of Warcraft Cataclysm" name="World of Warcraft Cataclysm Logo" src="./template/style/images/misc/realm_expansion_wotlk.png" />
            </div>
        <!-- REALM TOP INFO.End -->
                    ...
                    <div class="statistic_holder">
                        ...
                        <div class="race_class_stats">
                            ...
                            <?php
								...
								$worgenPct = $CORE->percent((int)$details->worgens, $details->total);
								$goblinPct = $CORE->percent((int)$details->goblins, $details->total);
								...
								<!-- Worgen -->
								<div class="bar_row">
									<div class="scale" style="width:', $worgenPct + 20, '%;">
										<div class="ico" style="background-image:url(http://wow.zamimg.com/images/wow/icons/small/race_worgen_male.jpg);"></div>
										<span>', $worgenPct, '%</span>
									</div>
									<h1>', (int)$details->worgens, ' <span>Worgens</span></h1>
								</div>
								
								<!-- Goblin -->
								<div class="bar_row">
									<div class="scale" style="width:', $goblinPct + 20, '%;">
										<div class="ico" style="background-image:url(http://wow.zamimg.com/images/wow/icons/small/race_goblin_male.jpg);"></div>
										<span>', $goblinPct, '%</span>
									</div>
									<h1>', (int)$details->worgens, ' <span>Goblins</span></h1>
								</div>';
								
								unset($bloodelfPct, $draeneiPct, $dwarfPct, $gnomePct, $humanPct, $nightelfPct, $orcPct, $taurenPct, $trollPct, $undeadPct, $worgenPct, $goblinPct);
							?>
