...
<div class="sidebar">
    ...
    <!-- REALMLIST -->
      <div class="realmlist home_container">
            <div class="light_normal">
            	<p><img src="http://cdn.openwow.com/images/tbc.png" height="11" width="33"> set realmlist <font color="#817464">logon.magical-wow.info:3725</font></p>
            </div>
        </div>
    ...
    <!-- REALMLIST.End -->
	  ...
	  <!-- REALMLIST -->
       <div class="realmlist home_container">
            <div class="light_normal">
            	<p><img src="/template/style/images/cata.png" height="11" width="33"> set realmlist <font color="#817464">logon.magical-wow.info</font></p>
            </div>
        </div>
                   ...
                   <div class="realm_st">
                      <!--  <a href="index.php?page=realm-details&id=', $id, '">-->
                            <div class="realmst_head">
								...
								<p class="realm-uptime" id="realm-uptime-', $id, '">0d 0h 0m 0s uptime</p>
                            </div>
                        <!--</a>-->
                    </div>
                <!-- REALM.End -->';
