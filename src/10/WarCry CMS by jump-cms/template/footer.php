 ...
 <!-- Footer -->
    <div class="footer-holder">
        <div id="footer">
            ...
            <div class="left-side">
            	<a class="evil-logo" href="#" target="_blank">EvilSystem Designs</a>
                ...
                <p>
                	All rights reserved ® <b>MAGCAL</b> World Of Warcraft <br/>
					The website and its content was created for <i>MAGICAL-WOW</i>.
                </p>
            </div>
