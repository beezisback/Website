...
<meta name="google-site-verification" content="safXDzISx_6G9-ROS2VfApCdzriHOE__is9EPj8mTmQ" />
<meta name="author" content="Magical-WoW">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<meta name="title" content="<?PHP echo $HeaderTitle; ?> page.">
<meta http-equiv="Content-Language" content="en">
<meta name="description" content="MaGiCal-WoW 4.3.4 and 2.4.3 and 3.3.5a World of Warcraft Private Server Games, Free, Игри">
<meta name="keywords" content="Magical, Magical-WoW, 4.3.4, 2.4.3, 4.0.6, 3.3.5a, Magical WoW, Games, Warlords of Draenor, Игра, 85, level, 70, level, server, free, magical.com,magical-wow.info, free servers, Warlords of Draenor private server, free wow server, wow forum,mmorpg server, pandaren, naga, new race, 255 level,largest server,quality server, quality server,">
<meta name="language" content="English">
<meta name="type" content="website">
<meta name="copyright" content="Copyright www.magical-wow.info">
<meta name="resource-type" content="games">
<meta name="Distribution" content="Global">
<meta name="email" content="csprobgwebsite@abv.bg">
...
<meta name="DC.Rights" content="(c) magical-wow.info all rights reserved.">
...
<script type="text/javascript" language="javascript">
	...
	var $SocialButtons = {
		facebook: {
			enabled: "', ($config['FACEBOOK']['enabled'] ? 'true' : 'false'), '",
		...
		twitter: {
			enabled: "', ($config['TWITTER']['enabled'] ? 'true' : 'false'), '",
	...
	else
	{
		if ($TPL->GetParameter('slider'))
		{
			...
			$(document).ready(function()
			{
				$("#html5-video").videoBG(
				{
					mp4: "/resources/movies/cwc.mp4",
					ogv: "/resources/movies/cwc.ogv",
					webm: "/resources/movies/cwc.webm",
					poster: "/resources/movies/cwc.jpg",
					scale: false,
					loop: true,
					zIndex: 0,
					left: "50%",
		...
		{
			echo '
			<div class="sub_head_image" align="center" style="height: 394px;">
				<!-- TextFader Cycle JQuery Plugin -->
				<script type="text/javascript">
					$(function() {
						$("#IndexTextFader img").css({
...
if ($TPL->GetParameter('topbar'))
{
	...
	<div class="membership-holder">
  		<div class="membership-bar">
         	...
         	<div class="search">
				<form action="', $config['BaseURL'], '#" method="get" id="search">
            ...
            else
			{
            	...
            	<!-- Logged In -->
     			<div class="logged_in_bar member-side-left">
       				...
       				<div class="info">
         				<p>Welcome back, <a href="', $config['BaseURL'], '/index.php?page=profile&uid=', $CURUSER->get('id'), '"><font color="#e9ac35">', $CURUSER->get('displayName'), '</a></font>!</p>
         				<div class="coints">
