...
{
	static public function AddRefundable($itam, $entry, $price, $currency, $character, $account = false)
	{
		...
		$insert = $DB->prepare("INSERT INTO `refundable_items` (`itam`, `entry`, `price`, `currency`, `character`, `account`, `time`, `status`) VALUES (:itam, :entry, :price, :currency, :character, :account, :time, :status);");
		$insert->bindParam(':itam', $itam, PDO::PARAM_INT);
