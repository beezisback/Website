...
$recruiter = 0;
	...
	//register
  	if ($accountId = server_Account::register($username, $password, $email, $expansion, $recruiter))
  	{
		...
		$mail->FromName =  'Magical-WoW - Info';
		...
		{				
			...
			$mail->Subject = "Magical-WoW Registration";
			$mail->Body    = $message;
		...
		$NOTIFICATIONS->SetText('Welcome and thank you for joining the Magical-WoW community.<br>Your Magical-WoW account has been automatically activated.<br>Please enjoy.');
