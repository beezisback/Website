...
<script type="text/javascript">
	...
	function ItemAutofill()
	{
		...
		function(data)
		{
			...
			var icon = data.icon;
			var classs = data.classInt;
			var subclass = data.subclassInt;
			var inventorySlot = data.inventoryTypeInt;
			...
			$('.item-class').find('option[value="'+classs+'"]').attr('selected', 'selected');
			$('.item-class').trigger('change');
			
			$('#subclass-of-class-' + classs).find('option:selected').attr('selected', null);
			$('#subclass-of-class-' + classs).find('option[value="'+subclass+'"]').attr('selected', 'selected');
			$('#subclass-of-class-' + classs).trigger('change');
