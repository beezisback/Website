...
<nav id="secondary" class="disable-tabbing">
	<ul>
		...
		<li><a href="index.php?page=logs-as">Armor Sets Purchase Logs</a></li>
        ...
        <li class="current"><a href="index.php?page=logs-customiz">P.Store Re-customization Logs</a></li>
...
<section id="content">
    ...
    <div class="tab" id="maintab">
		<h2>P.Store Re-customization Logs</h2>
