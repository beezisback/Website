...
class Pagination
{
	...
	public function calculate_pages($total_rows, $rows_per_page, $page_num)
	{
		...
		{
        	$first_page_btn_html = '<a href="'.$this->LinkAdd.'&p=1">First</a>';
        }
		...
		{
			$prev_page_btn_html = '<a href="'.$this->LinkAdd.'&p='.($page_num - 1).'">Prev</a>';
		}				
		...
		{
			$next_page_btn_html = '<a href="'.$this->LinkAdd.'&p='.($page_num + 1).'">Next</a>';
		}
		...
		{
			$last_page_btn_html = '<a href="'.$this->LinkAdd.'&p='.$last_page.'">Last&raquo;</a>';
		}
