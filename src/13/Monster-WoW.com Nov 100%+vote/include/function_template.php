...
class Template
{
  ...
  function loadfile($filename)
  {
    ...
    $fd = fopen($filename, "r") or die("<br><br><font color=red>Your current style is missing some files. They do not exist, or the style is outdated. Please use the latest available core and modules.</font><br><a href='./include/styleupdater.php'>Try this style update tool. (This will more than likely fix the outdated style.)</a><br></red>");
    $content = fread($fd, filesize($filename));
	$content = substr($content, 14); //strip out php exit
    fclose($fd);
