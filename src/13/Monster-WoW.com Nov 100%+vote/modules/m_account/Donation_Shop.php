...
if (!isset($_SESSION['realm'])) 
{
						 ...
						 $cont2.="<div class='account-realm-menu'><div id='item'><form method='POST' action='./quest_ac.php?name=Donation_Shop'><input type='hidden' value='".$j."' name='id'><div id='log-b2'><input type='submit' value='".$realm[$j]['name']."' name='realm' id='active-item' /></div></form></td>";
...
$cont2.="<table cellspan='0' rowspan='0'>";
						 ...
						 $cont2.='
<form method="post" action="./quest_ac.php?name=Donation_Shop">
