...
<xsl:template match="/">
	...
	<head>
		<title>Apex WoW Server Status Page</title>
...
<xsl:template match="status">
	<table width="100%" border="0" cellspacing="1" cellpadding="3">
		<tr class="head"><th colspan="4">Apex-WoW All-Free Server Status</th></tr>
		<tr>
	...
	<form>
	<input type="button" class="button" value="Home" onClick="window.location='../'" />
	<input type="button" class="button" value="Account Creation" onClick="window.location='../quest.php?name=register'" />
	</form>
	</div>
</xsl:template>
...
<xsl:template match="oplayers"></xsl:template>
<xsl:template match="cpu"></xsl:template>
<xsl:template match="qplayers"></xsl:template>
<xsl:template match="ram"></xsl:template>
<xsl:template match="avglat"></xsl:template>
...
<xsl:template match="acceptedconns"></xsl:template>
<xsl:template match="peakcount"></xsl:template>
...
<xsl:template match="instances">
	<table width="100%" border="0" cellspacing="1" cellpadding="2">
		...
		<tr>
			...
			<td align="center"><xsl:value-of select="players" /></td>
			<td align="center">
			<xsl:choose>
				<xsl:when test="maxplayers = 0">-</xsl:when>
				<xsl:otherwise><xsl:value-of select="maxplayers" /></xsl:otherwise>
			</xsl:choose>
			</td>
			<td align="center"><xsl:value-of select="state" /></td>
			<td align="center">
			<xsl:choose>
				<xsl:when test="maptype = 0">World</xsl:when>
                <xsl:when test="maptype = 1">Raid</xsl:when>
                <xsl:when test="maptype = 2">Instance</xsl:when>
				<xsl:otherwise>?</xsl:otherwise>
			</xsl:choose>
            </td>
			<td align="right"><xsl:value-of select="creationtime" /></td>
			<td align="right"><xsl:value-of select="expirytime" /></td>
		</tr>
		</xsl:for-each>
	</table>
</xsl:template>
...
<xsl:template match="gms">
	<table width="100%" border="0" cellspacing="1" cellpadding="2">
		...
		<tr>
			...
			<td align="center">
				<xsl:choose>
					<xsl:when test="gender = 1">
						<xsl:choose>
							<xsl:when test="race = 1"><img src="../images/icon/race/1-1.gif" alt="Human" /></xsl:when>
							<xsl:when test="race = 2"><img src="../images/icon/race/2-1.gif" alt="Orc" /></xsl:when>
							<xsl:when test="race = 3"><img src="../images/icon/race/3-1.gif" alt="Dwarf" /></xsl:when>
							<xsl:when test="race = 4"><img src="../images/icon/race/4-1.gif" alt="Night Elf" /></xsl:when>
							<xsl:when test="race = 5"><img src="../images/icon/race/5-1.gif" alt="Undead" /></xsl:when>
							<xsl:when test="race = 6"><img src="../images/icon/race/6-1.gif" alt="Tauren" /></xsl:when>
							<xsl:when test="race = 7"><img src="../images/icon/race/7-1.gif" alt="Gnome" /></xsl:when>
							<xsl:when test="race = 8"><img src="../images/icon/race/8-1.gif" alt="Troll" /></xsl:when>
							<xsl:when test="race = 10"><img src="../images/icon/race/10-1.gif" alt="Blood Elf" /></xsl:when>
							<xsl:when test="race = 11"><img src="../images/icon/race/11-1.gif" alt="Draenei" /></xsl:when>
						</xsl:choose>
					</xsl:when>
					<xsl:otherwise>
						<xsl:choose>
							<xsl:when test="race = 1"><img src="../images/icon/race/1-0.gif" alt="Human" /></xsl:when>
							<xsl:when test="race = 2"><img src="../images/icon/race/2-0.gif" alt="Orc" /></xsl:when>
							<xsl:when test="race = 3"><img src="../images/icon/race/3-0.gif" alt="Dwarf" /></xsl:when>
							<xsl:when test="race = 4"><img src="../images/icon/race/4-0.gif" alt="Night Elf" /></xsl:when>
							<xsl:when test="race = 5"><img src="../images/icon/race/5-0.gif" alt="Undead" /></xsl:when>
							<xsl:when test="race = 6"><img src="../images/icon/race/6-0.gif" alt="Tauren" /></xsl:when>
							<xsl:when test="race = 7"><img src="../images/icon/race/7-0.gif" alt="Gnome" /></xsl:when>
							<xsl:when test="race = 8"><img src="../images/icon/race/8-0.gif" alt="Troll" /></xsl:when>
							<xsl:when test="race = 10"><img src="../images/icon/race/10-0.gif" alt="Blood Elf" /></xsl:when>
							<xsl:when test="race = 11"><img src="../images/icon/race/11-0.gif" alt="Draenei" /></xsl:when>
						</xsl:choose>
					</xsl:otherwise>
				</xsl:choose>
			</td>
			<td align="center">
				<xsl:choose>
					<xsl:when test="class = 1"><img src="../images/icon/class/1.gif" alt="Warrior" /></xsl:when>
					<xsl:when test="class = 2"><img src="../images/icon/class/2.gif" alt="Paladin" /></xsl:when>
					<xsl:when test="class = 3"><img src="../images/icon/class/3.gif" alt="Hunter" /></xsl:when>
					<xsl:when test="class = 4"><img src="../images/icon/class/4.gif" alt="Rogue" /></xsl:when>
					<xsl:when test="class = 5"><img src="../images/icon/class/5.gif" alt="Priest" /></xsl:when>
					<xsl:when test="class = 7"><img src="../images/icon/class/7.gif" alt="Shaman" /></xsl:when>
					<xsl:when test="class = 8"><img src="../images/icon/class/8.gif" alt="Mage" /></xsl:when>
					<xsl:when test="class = 9"><img src="../images/icon/class/9.gif" alt="Warlock" /></xsl:when>
					<xsl:when test="class = 11"><img src="../images/icon/class/11.gif" alt="Druid" /></xsl:when>
				</xsl:choose>
			</td>
			<td align="center"><xsl:value-of select="level"/></td>
			<td align="center">[<xsl:value-of select="permissions"/>]</td>
			<td><xsl:value-of select="ontime"/></td>
			<td align="right"><xsl:value-of select="latency"/>ms</td>
		</tr>
		</xsl:for-each>
	</table>
</xsl:template>
...
<xsl:template match="sessions">
	<table width="100%" border="0" cellspacing="1" cellpadding="2">
		...
		<tr>
			...
			<td align="center">
				<xsl:choose>
					<xsl:when test="pvprank = 1"><img src="../images/icon/pvpranks/rank1.gif" alt="Private - Scout" /></xsl:when>
					<xsl:when test="pvprank = 2"><img src="../images/icon/pvpranks/rank2.gif" alt="Corporal - Grunt" /></xsl:when>
					<xsl:when test="pvprank = 3"><img src="../images/icon/pvpranks/rank3.gif" alt="Sergeant - Sergeant" /></xsl:when>
					<xsl:when test="pvprank = 4"><img src="../images/icon/pvpranks/rank4.gif" alt="Master Sergeant - Senior Sergeant" /></xsl:when>
					<xsl:when test="pvprank = 5"><img src="../images/icon/pvpranks/rank5.gif" alt="Sergeant Major - First Sergeant" /></xsl:when>
					<xsl:when test="pvprank = 6"><img src="../images/icon/pvpranks/rank6.gif" alt="Knight - Stone Guard" /></xsl:when>
					<xsl:when test="pvprank = 7"><img src="../images/icon/pvpranks/rank7.gif" alt="Knight-Lieutenant - Blood Guard" /></xsl:when>
					<xsl:when test="pvprank = 8"><img src="../images/icon/pvpranks/rank8.gif" alt="Knight-Captain - Legionnaire" /></xsl:when>
					<xsl:when test="pvprank = 9"><img src="../images/icon/pvpranks/rank9.gif" alt="Knight-Champion - Centurion" /></xsl:when>
					<xsl:when test="pvprank = 10"><img src="../images/icon/pvpranks/rank10.gif" alt="Lieutenant - Commander Champion" /></xsl:when>
					<xsl:when test="pvprank = 11"><img src="../images/icon/pvpranks/rank11.gif" alt="Commander Lieutenant - General" /></xsl:when>
					<xsl:when test="pvprank = 12"><img src="../images/icon/pvpranks/rank12.gif" alt="Marshal - General" /></xsl:when>
					<xsl:when test="pvprank = 13"><img src="../images/icon/pvpranks/rank13.gif" alt="Field Marshal - Warlord" /></xsl:when>
					<xsl:when test="pvprank = 14"><img src="../images/icon/pvpranks/rank14.gif" alt="Grand Marshal - High Warlord" /></xsl:when>
					<xsl:when test="pvprank = 15"><img src="../images/icon/pvpranks/rank15.gif" alt="??" /></xsl:when>
					<xsl:otherwise>
						<xsl:choose>
							<xsl:when test="race = 1 or race = 3 or race = 4 or race = 7 or race = 11"><img src="../images/icon/pvpranks/rank_default_0.gif" alt="Alliance" /></xsl:when>
							<xsl:when test="race = 2 or race = 5 or race = 6 or race = 8 or race = 10"><img src="../images/icon/pvpranks/rank_default_1.gif" alt="Horde" /></xsl:when>
						</xsl:choose>
					</xsl:otherwise>
				</xsl:choose>
			</td>
			...
			<td>
				<xsl:choose>
					...
					<xsl:when test="map = 566">Eye of the Storm</xsl:when>
					<xsl:when test="map = 568">Zul'Aman</xsl:when>
					<xsl:otherwise>Unknown Map</xsl:otherwise>
				</xsl:choose>
			</td>
			...
			<td>
				<xsl:choose>
					...
					<xsl:otherwise>Unknown Area</xsl:otherwise>
				</xsl:choose>
			</td>
