...
<a href='./quest.php?name=account'>Back to Account</a>
	...
	while ($i<=count($realm))
	{
		...
		{
			$cont2.= "<option selected='selected' value=' ".$char2[$db_translation['characters_guid']]."-".$i."'>".$realm[$i]['']."  ".$char2[$db_translation['characters_name']]."</option>";
			$cont2.= '<option selected="selected" value=" <img src="./images/icon/race/'.$char[$db_translation['characters_race']].'-'.$char[$db_translation['characters_gender']].'.gif"  title="Race" /></option><br>
		';
		}
  ...
  //******END DROPDOWN********
	$cont2.= "<div style='height: 0px; overflow: hidden; position: absolute;' id='amount_msddHolder'><div id='pageWrap'><select name='location' id='amount' style='width:201px;'><option selected='selected' id='1' value='1'>Stormwind</option><option value='2'>Ironforge</option><option value='3'>Darnassus</option><option id='4' value='4'>Exodar</option><option id='4' value='13'>Valiance Keep</option><option value='---------'>-----------------HORDE-------------------</option><option id='5' value='5'>Orgrimmar</option><option id='6' value='6'>Thunder Bluff</option><option id='7' value='7'>Undercity</option><option id='8' value='8'>Silvermoon</option><option value='0'>Warsong Hold</option><option value='0'>--Neutral--</option><option value='9'>Shattrath</option><option value='15'>Dalaran</option></select></div><div id='amount_msdd' class='dd' style='width: 199px;'><div id='amount_title' class='ddTitle'><span id='amount_arrow' class='arrow'></span></form>";
...
while ($i<=count($realm))
{
	...
	while ($char = $db->fetch_assoc($result))
	{
		...
		$cont2.= '<img src="./images/icon/race/'.$char[$db_translation['characters_race']].'-'.$char[$db_translation['characters_gender']].'.gif"  title="Race" /><br>
		';
