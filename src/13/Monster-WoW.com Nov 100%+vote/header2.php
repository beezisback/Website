...
<div align="center">
	...
	<div id="container">
		...
		<div id="header">
		  ...
		  <!-- if(link_guest) -->
		  <li><a id="register" href="{linkpath}"><p></p><span></span></a></li>
		 ...
		 <li> <a href="{linkpath2}" >{title2}</a><p></p><span></span></a></li>
		 ...
		 <li> <a href="{linkpath3}" >{title3}</a><p></p><span></span></a></li>
         <li><a id="logout" href="index.php?logout=true"><p></p><span></span></a></li>
		  <!-- else(link_loggedin1) -->
		  <!-- endif(link_loggedin1) -->
