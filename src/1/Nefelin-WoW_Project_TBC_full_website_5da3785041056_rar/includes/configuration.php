<?php
	...
	/*************************/
	 ...
	 $website_title = 'Nefelin | WoW Private Server'; //The title of your website, shown in the users browser.
	 ...
	 $default_email = 'csprobgwebsite@abv.bg'; //The default email address from wich Emails will be sent.

	 $website_domain = 'https://tbc.nefelin-wow.com/'; //Provide the domain name AND PATH to your website.
	 ...
	 $footer_text = 'Copyright &copy; Nefelin | WoW Private Server 2019<br/>
	...
	$serverStatus['nextArenaFlush'] = true; //This will display the next arena flush for your realm(s).
	...
	$connection['host'] = '87.254.177.88';
	$connection['user'] = 'root';
	$connection['password'] = 'ascent';
	$connection['logondb'] = 'auth';
	$connection['webdb'] = 'wowsite';
	$connection['worlddb'] = 'world';
	$connection['realmlist'] = '87.254.177.88';
