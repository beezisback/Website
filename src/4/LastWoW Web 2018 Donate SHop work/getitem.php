...
if(isset($_GET['q'])){ 
							  ...
							  {		
                                ...
                                $row = mysql_fetch_assoc($vote_costs);
								 ...
								 if ($items["custom"]=="1"){          
                                        ...
                                        $donate = $row["dp"];
										echo "<br>";
										echo "<a class='q".$items['Quality']."' href='http://tbc.cavernoftime.com/item=".$items['entry']."' target='_blank'><b><font size='4'>".$items['name']."</b></a></font>";									
										echo "<br>";
									//	echo " <span> | </span>";
		...
		if ($a_user['vp']>=$cost OR $a_user['dp']>=$donate)
		{
			...
			echo'</table><br/><br/>
							...
							echo  "</select> ";
							//#########################################CHAR END
                            echo '<br /><br /><div id="log-b3"><input style="border: 1px solid black; height: 24px; width:150px" name="action" value="Get the item" type="submit"><br /><br />';
		                    }
		                   else
		                    {
