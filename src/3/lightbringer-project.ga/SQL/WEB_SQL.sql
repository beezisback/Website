...
-- Records of news
-- ----------------------------
INSERT INTO `news` VALUES ('95', 'Welcome!', '<p><span style=\"color: white\">This is your new awesome website. Please be sure to LEAVE THE FOOTER ALONE, and +rep Jeutie on AC-Web if you like the release. Contact Evil! If you want custom logos or images. The errors displayed are caused by outdated code. You can hide them via your php.ini. The voteshop has to be managed via the database, some examples are in place. Enjoy!</span></p>', '0', '1299865425', 'March 11, 2011', 'admin');
