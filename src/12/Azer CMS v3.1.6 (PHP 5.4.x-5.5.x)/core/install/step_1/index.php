<?php if(!defined('ACMS')){ header("Location: ../../../"); }
  class step_1
  {
    ...
    function tables()
    {
      ...
      // Create the table for Captcha
      $connect->query("CREATE TABLE `verify` (`id` int(32) NOT NULL auto_increment, `body` varchar(32) default NULL, `ipa` longtext, PRIMARY KEY  (`id`)) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE='utf8mb4_unicode_ci' AUTO_INCREMENT=1");
