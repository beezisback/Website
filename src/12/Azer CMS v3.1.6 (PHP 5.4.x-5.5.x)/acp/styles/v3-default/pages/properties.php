              ...
              <table class="tblg" cellpadding="0" cellspacing="0">
                <tr id="head">
                  <td width="70%"><b>Expansion:</b> Which expansion should your users be registered with?</td>
                   <td width="30%"><select name="expansion"><option value="{prop_data.ex}">{prop_data.exp}</option><option value="{prop_data.ex1}">{prop_data.exp1}</option><option value="{prop_data.ex2}">{prop_data.exp2}</option></select></td>
                </tr>
              </table>
            </div>
          </div>
