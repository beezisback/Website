            ...
            <div style="padding:3px 0px 3px 0px;">
              <table class="ltbl" cellpadding="0" cellspacing="0">
                <tr id="head">
                  ...
                  <td width="6%"><input type="text" name="soap" value="SOAP Port" class="fsa" AutoComplete="off" onfocus='if (this.value == "SOAP Port") this.value = "";' onblur='if (!this.value){ this.value = "SOAP Port"; }'></td>
