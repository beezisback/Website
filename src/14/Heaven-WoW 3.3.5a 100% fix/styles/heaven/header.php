...
<div id="blink" style="margin:90px auto -270px 112px;">
<OBJECT CLASSID="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" WIDTH="780" HEIGHT="280" CODEBASE="http://active.macromedia.com/flash5/cabs/swflash.cab#version=5,0,0,0">
	<PARAM NAME="MOVIE" VALUE="2.swf">
	<PARAM NAME="PLAY" VALUE="true">
	<PARAM NAME="LOOP" VALUE="true">
	<PARAM NAME="QUALITY" VALUE="high">
	<PARAM NAME="SCALE" value="noborder">
	<EMBED SRC="./styles/heaven/new_images/2.swf" WIDTH="780" HEIGHT="180" PLAY="true" LOOP="true" QUALITY="high" scale="noborder"PLUGINSPAGE="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash"></EMBED>
</OBJECT></div>
