...
//$sql = "SELECT * FROM " . $dbweb . ".store WHERE cat='1'";
...
?>
                <div class="col-lg-4 col-md-6 pb-4">
                    <div class="card dark" data-item-icon-name="<?php echo $item_icons; ?>" data-se="<?php echo $itemid; ?>" data-name="<?php echo $big_name; ?>" data-price="Free" data-quality="<?php echo $item_color; ?>" data-itemid="<?php echo $itemid; ?>">
                        <div class="faction-icons">
<?php
if ($row['faction'] == 0){ 
        echo '<div class="game-icon--rounded game-icon game-icon-xs game-icon--faction-0"><div class="game-icon-icon"></div></div>'; 
       }
       else
...
if ($row['faction'] == 1){ 
        ...
        echo '<div class="game-icon--rounded game-icon game-icon-xs game-icon--faction-1"><div class="game-icon-icon"></div></div>'; 
       }
...
if ($row['faction'] == 3){ 
       echo '<div class="game-icon--rounded game-icon game-icon-xs game-icon--faction-0"><div class="game-icon-icon"></div></div>
             <div class="game-icon--rounded game-icon game-icon-xs game-icon--faction-1"><div class="game-icon-icon"></div></div>'; 
...
?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="si-desc"><?php echo $disc; ?></div>
